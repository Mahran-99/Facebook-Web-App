				                    ...
				                    <form action="register.php" method="POST" class="login-form">
                                       <!-- Email Addresss -->
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="log_email" placeholder="Email Address" class="form-email form-control" value="<?php if(isset($_SESSION['log_email'])){
	                            ...
	                            <div class="form-bottom">
				                    <form action="register.php" method="POST" class="registration-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-type form-control" type="text" name="reg_type" placeholder="type"  required>
                                        </div>
